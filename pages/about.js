    ...
    return (
        <React.Fragment>
            ...
            <motion.main initial ="hidden"  animate="visible" variants= {{
                ...
                <Container className={classes.cardGrid} maxWidth="md">
                    <Typography component="h4" variant="h4" align="left" style={{ color: '#fff' }} gutterBottom>
                        <BeenhereIcon color="secondary" />  <Typed
                        strings={['Qualities']}
                        typeSpeed={70}
                    />
                    </Typography>
                    ...
                    <Grid container spacing={3} style={{ marginTop : '3%'}}>
                        <Grid item xs={12} sm={6}>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Problem-solver</span>
                            </Typography>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Lifelong learner</span>
                            </Typography>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Curious</span>
                            </Typography>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Self-disciplined</span>
                            </Typography>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Communication skills</span>
                            </Typography>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Love for technology</span>
                            </Typography>
                            <Typography className={classes.skillsTitle} align="left" style={{ color: '#eedd00'}} variant="h6" paragraph>
                                <GradeIcon fontSize="small" /> <span style={{ color: '#fff'}}>Self-taught</span>
                            </Typography>
                        </Grid>
                    </Grid>
                </Container>
            ...
            <motion.main initial ="hidden"  animate="visible" variants= {{
                ...
                <Container className={classes.cardGrid} maxWidth="md">
                    <Typography component="h4" variant="h4" align="left" style={{ color: '#fff' }} gutterBottom>
                        <SportsRugbyIcon color="secondary" />  <Typed
                        strings={['Hobbies']}
                        typeSpeed={70}
                    />
                    </Typography>
                    ...
                    <FitnessCenterIcon className={classes.hobby} fontSize='large' style={{ color: '#fff' }}/>
                    <SportsSoccerIcon className={classes.hobby} fontSize='large' style={{ color: '#fff' }}/>
                    <MusicNoteIcon className={classes.hobby} fontSize='large' style={{ color: '#fff' }}/>
